/**
 * MonoMuse — Phase B final site behavior
 *
 * External libraries (cite in project documentation):
 * - jQuery 4.x: https://jquery.com/ — Read More/Less (index), membership FAQ accordion
 * - Leaflet 1.9.x: https://leafletjs.com/ — OpenStreetMap map (explore.html only; script loaded there)
